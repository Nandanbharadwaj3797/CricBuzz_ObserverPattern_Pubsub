...
public class Match {
    ...
    public Match(String matchId, Team team1, Team team2, String venue, String date, String time, String status, Innings innings1, Innings innings2, List<String> commentary) {
